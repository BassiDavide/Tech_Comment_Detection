...
class MultitaskDataset(Dataset):
    ...
    def __init__(self, texts: List[str], comment_labels: np.ndarray, 
        ...
        self.texts = texts
        self.comment_labels = comment_labels  # Multi-label binary vectors
        self.token_labels = token_labels  # Multi-label token cues (seq_len, num_labels)
    ...
    def __getitem__(self, idx):
        ...
        return {
            ...
            'comment_labels': torch.FloatTensor(comment_label),  # For multi-label classification
            'token_labels': torch.FloatTensor(token_label)  # Multi-label token targets
        }
